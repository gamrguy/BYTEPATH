...
function Classes:draw()
    ...
    local drawNormalButton = function(x, y, w, h, text, color)
        drawCenteredRectangle('fill', x, y, w, h, color255To1({16, 16, 16}))
        drawCenteredRectangle('line', x, y, w, h, color255To1({4, 4, 4}))
        printCenteredText(text, x, y, self.font, color)
    end

    local drawInvertedButton = function(x, y, w, h, text, color)
        drawCenteredRectangle('fill', x, y, w, h, color255To1({222, 222, 222}))
        drawCenteredRectangle('line', x, y, w, h, {1, 1, 1})
        printCenteredText(text, x, y, self.font, color255To1({16, 16, 16}))
    end
